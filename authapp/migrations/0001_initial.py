    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activation_key_expires', models.DateTimeField(default=datetime.datetime(2022, 4, 22, 14, 13, 31, 462244, tzinfo=utc))),
                ('role', models.CharField(choices=[('U', 'Зарегистрированный пользователь'), ('M', 'Модератор'), ('A', 'Администратор')], default='U', max_length=1, verbose_name='роль')),
