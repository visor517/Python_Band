# Generated by Django 3.2.12 on 2022-04-24 18:52
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activation_key_expires', models.DateTimeField(default=datetime.datetime(2022, 4, 26, 18, 52, 7, 629242, tzinfo=utc))),
                ('role', models.CharField(choices=[('U', 'Зарегистрированный пользователь'), ('A', 'Администратор'), ('M', 'Модератор')], default='U', max_length=1, verbose_name='роль')),
