    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activation_key_expires', models.DateTimeField(default=datetime.datetime(2022, 4, 27, 17, 31, 51, 110215, tzinfo=utc))),
                ('role', models.CharField(choices=[('M', 'Модератор'), ('A', 'Администратор'), ('U', 'Зарегистрированный пользователь')], default='U', max_length=1, verbose_name='роль')),
