    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('activation_key_expires', models.DateTimeField(default=datetime.datetime(2022, 4, 19, 13, 41, 49, 878043, tzinfo=utc))),
                ('role', models.CharField(choices=[('A', 'Администратор'), ('U', 'Зарегистрированный пользователь'), ('M', 'Модератор')], default='U', max_length=1, verbose_name='роль')),
